...
const U = { year: e, month: e, day: e },
  ...
  at = { year: e, month: s, day: e, hour: e, minute: e, second: e, timeZoneName: n },
  ot = { year: e, month: s, day: e, weekday: s, hour: e, minute: e, timeZoneName: s },
  ut = { year: e, month: s, day: e, weekday: s, hour: e, minute: e, second: e, timeZoneName: s };
class i {
  get type() {
    throw new r();
  }
...
function ft(t, e) {
  var t = t.format(e).replace(/\u200E/g, ""),
    [, e, t, r, n, s, i, a] = /(\d+)\/(\d+)\/(\d+) (AD|BC),? (\d+):(\d+):(\d+)/.exec(t);
...
class h extends i {
  ...
  constructor(t) {
    super(), (this.zoneName = t), (this.valid = h.isValidZone(t));
  }
  get type() {
    return "iana";
  }
  ...
  constructor(t, e, r) {
    ...
    t.zone.isUniversal
      ? ((s = 0 <= (s = (t.offset / 60) * -1) ? "Etc/GMT+" + s : "Etc/GMT" + s),
        0 !== t.offset && h.create(s).valid
          ? ((n = s), (this.dt = t))
          : ((n = "UTC"),
            r.timeZoneName
              ? (this.dt = t)
              : (this.dt = 0 === t.offset ? t : L.fromMillis(t.ts + 60 * t.offset * 1e3))))
      : "system" === t.zone.type
      ? (this.dt = t)
...
class O {
  ...
  get fastNumbers() {
    return (
      null == this.fastNumbersCached && (this.fastNumbersCached = Ct(this)), this.fastNumbersCached
    );
  }
  listingMode() {
  ...
  months(r, n = !1, t = !0) {
    return It(this, r, t, me, () => {
      ...
      return (
        this.monthsCache[t][r] || (this.monthsCache[t][r] = Vt((t) => this.extract(t, e, "month"))),
  ...
  weekdays(r, n = !1, t = !0) {
    return It(this, r, t, we, () => {
      const e = n ? { weekday: r, year: "numeric", month: "long", day: "numeric" } : { weekday: r },
        t = n ? "format" : "standalone";
      return (
    ...
    return It(
      ...
      () => {
        if (!this.meridiemCache) {
          ...
          this.meridiemCache = [L.utc(2016, 11, 13, 9), L.utc(2016, 11, 13, 19)].map((t) =>
...
function Bt(t) {
  if (!M(t) && null !== t && "" !== t) return (t = 1e3 * parseFloat("0." + t)), Math.floor(t);
}
function Qt(t, e, r = !1) {
  const n = 10 ** e,
...
function ae(t) {
  var e = Number(t);
  if ("boolean" == typeof t || "" === t || Number.isNaN(e)) throw new o("Invalid unit value " + t);
  return e;
}
function oe(t, e) {
  const r = {};
...
function le(t) {
  return (
    (r = t), ["hour", "minute", "second", "millisecond"].reduce((t, e) => ((t[e] = r[e]), t), {})
  );
  var r;
}
...
class g {
  ...
  static parseFormat(e) {
    ...
    for (let t = 0; t < e.length; t++) {
      var a = e.charAt(t);
      "'" === a
        ? (0 < n.length && i.push({ literal: s, val: n }), (r = null), (n = ""), (s = !s))
        : s || a === r
        ? (n += a)
    ...
    const n = "en" === this.loc.listingMode(),
      ...
      i = (t) =>
        r.isOffsetFixed && 0 === r.offset && t.allowZ
          ...
          : "",
      a = () => (n ? be(r) : s({ hour: "numeric", hourCycle: "h12" }, "dayperiod")),
      o = (t, e) => (n ? Me(r, t) : s(e ? { month: t } : { month: t, day: "numeric" }, "month")),
      u = (t, e) =>
        n
          ? ke(r, t)
          : s(e ? { weekday: t } : { weekday: t, month: "long", day: "numeric" }, "weekday"),
      l = (t) => {
        var e = g.macroTokenToFormatOpts(t);
        return e ? this.formatWithSystemDefault(r, e) : t;
      },
      c = (t) => (n ? Ne(r, t) : s({ era: t }, "era"));
    return Ee(g.parseFormat(t), (t) => {
      switch (t) {
        case "S":
        ...
        case "ZZZZ":
          return r.zone.offsetName(r.ts, { format: "short", locale: this.loc.locale });
        case "ZZZZZ":
          return r.zone.offsetName(r.ts, { format: "long", locale: this.loc.locale });
        case "z":
          return r.zoneName;
        case "a":
          return a();
        ...
        case "EEEEE":
          return u("narrow", !1);
        case "L":
          return e ? s({ month: "numeric", day: "numeric" }, "month") : this.num(r.month);
        case "LL":
          return e ? s({ month: "2-digit", day: "numeric" }, "month") : this.num(r.month, 2);
        case "LLL":
          return o("short", !0);
        case "LLLL":
          return o("long", !0);
        ...
        case "yy":
          return e ? s({ year: "2-digit" }, "year") : this.num(r.year.toString().slice(-2), 2);
        case "yyyy":
...
function Ae(t, e) {
  return [{}, t[e] ? h.create(t[e]) : null, e + 1];
}
const qe = RegExp(`^T?${s.source}$`),
  je =
...
function We(t) {
  var [, t, e, r, n, s, i, a, o, u, l, c] = t,
    t = $e(t, n, r, e, s, i, a);
  let h;
  return (h = o ? Ue[o] : u ? 0 : ie(l, c)), [t, new d(h)];
}
const Re =
...
function Pe(t) {
  var [, t, e, r, n, s, i, a] = t;
  return [$e(t, n, r, e, s, i, a), d.utcInstance];
}
function Ge(t) {
  var [, t, e, r, n, s, i, a] = t;
  return [$e(t, a, e, r, n, s, i), d.utcInstance];
}
const Be = a(/([+-]\d{6}|\d{4})(?:-?(\d\d)(?:-?(\d\d))?)?/, Ce),
  Qe = a(/(\d{4})-?W(\d\d)(?:-?(\d))?/, Ce),
  Ke = a(/(\d{4})-?(\d{3})/, Ce),
  Xe = a(Ie),
  tr = v(
    function (t, e) {
      return [{ year: T(t, e), month: T(t, e + 1, 1), day: T(t, e + 2, 1) }, null, e + 3];
    },
    Le,
    ze,
    Ae
  ...
  nr = v(Le, ze, Ae);
function sr(t) {
  return p(t, [Be, tr], [Qe, er], [Ke, rr], [Xe, nr]);
}
function ir(t) {
  return p(
    t
...
const cr = a(/(\d{4})-(\d\d)-(\d\d)/, n),
  hr = a(e),
  dr = v(Le, ze, Ae);
function mr(t) {
  return p(t, [cr, tr], [hr, dr]);
}
const fr = {
...
function Sr(r, n) {
  pr.reduce((t, e) => (M(n[e]) ? t : (t && Tr(r, n, t, n, e), e)), null);
}
function Or(t) {
  const e = {};
...
class D {
  ...
  static fromMillis(t, e) {
    return D.fromObject({ milliseconds: t }, e);
  }
  ...
  static fromDurationLike(t) {
    if (c(t)) return D.fromMillis(t);
    if (D.isDuration(t)) return t;
    if ("object" == typeof t) return D.fromObject(t);
  ...
  static fromISO(t, e) {
    ...
    return r
      ? D.fromObject(r, e)
      : D.invalid("unparsable", `the input "${t}" can't be parsed as ISO 8601`);
  }
  ...
  static invalid(t, e = null) {
    ...
    t = t instanceof w ? t : new w(t, e);
    if (k.throwOnInvalid) throw new q(t);
    return new D({ invalid: t });
  }
  ...
  toFormat(t, e = {}) {
    ...
    return this.isValid
      ? g.create(this.loc, e).formatDurationFromString(this, t)
      : "Invalid Duration";
  }
  toHuman(r = {}) {
    var t = S.map((t) => {
      ...
      return M(e)
        ? null
        : this.loc
            .numberFormatter({ style: "unit", unitDisplay: "long", ...r, unit: t.slice(0, -1) })
            .format(e);
    }).filter((t) => t);
    return this.loc
  ...
  plus(t) {
    ...
    const e = D.fromDurationLike(t),
      r = {};
    for (const n of S) (m(e.values, n) || m(this.values, n)) && (r[n] = e.get(n) + this.get(n));
    return N(this, { values: r }, !0);
  }
  minus(t) {
    if (!this.isValid) return this;
    const e = D.fromDurationLike(t);
  ...
  mapUnits(t) {
    ...
    return N(this, { values: e }, !0);
  }
  get(t) {
    return this[D.normalizeUnit(t)];
  }
  set(t) {
    return this.isValid ? N(this, { values: { ...this.values, ...oe(t, D.normalizeUnit) } }) : this;
  }
  reconfigure({ locale: t, numberingSystem: e, conversionAccuracy: r, matrix: n } = {}) {
    t = this.loc.clone({ locale: t, numberingSystem: e });
    return N(this, { loc: t, matrix: n, conversionAccuracy: r });
  }
  as(t) {
  ...
  normalize() {
    if (!this.isValid) return this;
    var t = this.toObject();
    return Sr(this.matrix, t), N(this, { values: t }, !0);
  }
  rescale() {
    if (!this.isValid) return this;
    var t = Or(this.normalize().shiftToAll().toObject());
    return N(this, { values: t }, !0);
  }
  shiftTo(...t) {
    if (!this.isValid) return this;
    if (0 === t.length) return this;
    t = t.map((t) => D.normalizeUnit(t));
    const e = {},
      r = {},
      n = this.toObject();
    let s;
    for (const a of S)
      if (0 <= t.indexOf(a)) {
        ...
        for (const u in n) S.indexOf(u) > S.indexOf(a) && Tr(this.matrix, n, u, e, a);
      } else c(n[a]) && (r[a] = n[a]);
    for (const l in r) 0 !== r[l] && (e[s] += l === s ? r[l] : r[l] / this.matrix[s][l]);
    return N(this, { values: e }, !0).normalize();
  }
  shiftToAll() {
    return this.isValid
      ? this.shiftTo(
...
class E {
  ...
  static fromDateTimes(t, e) {
    var t = Ln(t),
      e = Ln(e),
      r = kr(t, e);
    return null == r ? new E({ start: t, end: e }) : r;
  }
  static after(t, e) {
    const r = D.fromDurationLike(e),
      n = Ln(t);
  ...
  static fromISO(t, s) {
    ...
    if (i && a) {
      ...
      if (e && n) return E.fromDateTimes(t, r);
      if (e) {
        var o = D.fromISO(a, s);
        if (o.isValid) return E.after(t, o);
      } else if (n) {
        o = D.fromISO(i, s);
  ...
  set({ start: t, end: e } = {}) {
    return this.isValid ? E.fromDateTimes(t || this.s, e || this.e) : this;
  }
  splitAt(...t) {
  ...
  splitBy(t) {
    ...
    for (; r < this.e; ) {
      ...
      (s = +a > +this.e ? this.e : a), i.push(E.fromDateTimes(r, s)), (r = s), (n += 1);
    }
    return i;
  }
  divideEqually(t) {
  ...
  intersection(t) {
    ...
    return t <= e ? null : E.fromDateTimes(e, t);
  }
  union(t) {
    if (!this.isValid) return this;
    var e = (this.s < t.s ? this : t).s,
      t = (this.e > t.e ? this : t).e;
    return E.fromDateTimes(e, t);
  }
  static merge(t) {
    const [e, r] = t
      .sort((t, e) => t.s - e.s)
      .reduce(
        ([t, e], r) =>
          e ? (e.overlaps(r) || e.abutsStart(r) ? [t, e.union(r)] : [t.concat([e]), r]) : [t, r],
        [[], null]
      );
    return r && e.push(r), e;
  }
  static xor(t) {
    ...
    for (const o of a)
      (r += "s" === o.type ? 1 : -1),
        (e = 1 === r ? o.time : (e && +e != +o.time && n.push(E.fromDateTimes(e, o.time)), null));
    return E.merge(n);
  }
  difference(...t) {
    return E.xor([this].concat(t))
  ...
  toFormat(t, { separator: e = " – " } = {}) {
    return this.isValid ? "" + this.s.toFormat(t) + e + this.e.toFormat(t) : br;
  }
  toDuration(t, e) {
    return this.isValid ? this.e.diff(this.s, t, e) : D.invalid(this.invalidReason);
  }
  mapEndpoints(t) {
  ...
  let [s, i, a, o] = (function (e, r, t) {
    ...
    for ([n, s] of [
      ...
      if (0 <= t.indexOf(n)) {
        a = n;
        let t = s(e, r);
        (o = e.plus({ [n]: t })) > r ? ((e = e.plus({ [n]: t - 1 })), --t) : (e = o), (i[n] = t);
      }
    return [e, i, o, a];
  })(t, e, r);
  (t = e - s),
    (r = r.filter((t) => 0 <= ["hours", "minutes", "seconds", "milliseconds"].indexOf(t))),
    0 === r.length &&
        ...
        (function (e) {
          ...
          if (isNaN(r)) {
            ...
            for (let t = 0; t < e.length; t++) {
              ...
              if (-1 !== e[t].search(Er.hanidec)) r += xr.indexOf(e[t]);
              else
                for (const a in Vr) {
                  var [s, i] = Vr[a];
                  s <= n && n <= i && (r += n - s);
...
const Cr = V(),
  ...
  jr = V("{2,4}"),
  _r = V("{4,6}"),
  Ur = `[ ${String.fromCharCode(160)}]`,
  $r = new RegExp(Ur, "g");
function Hr(t) {
  return t.replace(/\./g, "\\.?").replace($r, Ur);
}
function Wr(t) {
  return t.replace(/\./g, "").replace($r, " ").toLowerCase();
}
function F(t, r) {
  return null === t
    ? null
    : {
        regex: RegExp(t.map(Hr).join("|")),
        deser: ([e]) => t.findIndex((t) => Wr(e) === Wr(t)) + r,
      };
}
function Rr(t, e) {
    ...
    ...t.map((t) => {
      {
        ...
        const r = Kr(g.macroTokenToFormatOpts(t.val), e);
...
function Br(i, t, e) {
        ...
        const n = (t) => ({
          ...
          s = ((t) => {
            ...
            switch (t.val) {
              ...
              case "Z":
              case "ZZ":
                return Rr(new RegExp(`([+-]${C.source})(?::(${I.source}))?`), 2);
              case "ZZZ":
                return Rr(new RegExp(`([+-]${C.source})(${I.source})?`), 2);
              case "z":
  ...
  var [e, a] = [`^${(e = n).map((t) => t.regex).reduce((t, e) => `${t}(${e.source})`, "")}$`, e],
    e = RegExp(e, "i"),
    [a, o] = (function (t, e, r) {
      const n = t.match(e);
      if (n) {
        ...
        for (const i in r)
          if (m(r, i)) {
            ...
            !a.literal && a.token && (s[a.token.val[0]] = a.deser(n.slice(t, t + o))), (t += o);
          }
        return [n, s];
      }
      return [n, {}];
    ...
    [u, l, c] = o
      ? (function (n) {
          let t = null,
            e;
          return (
            M(n.z) || (t = h.create(n.z)),
            M(n.Z) || ((t = t || new d(n.Z)), (e = n.Z)),
            M(n.q) || (n.M = 3 * (n.q - 1) + 1),
            M(n.h) || (n.h < 12 && 1 === n.a ? (n.h += 12) : 12 === n.h && 0 === n.a && (n.h = 0)),
            0 === n.G && n.y && (n.y = -n.y),
            M(n.u) || (n.S = Bt(n.u)),
            [
      ...
      : [null, null, void 0];
  if (m(o, "a") && m(o, "H")) throw new j("Can't include meridiem when specifying 24-hour format");
  return {
    input: t,
    tokens: r,
    regex: e,
...
function Qr(t, e, r) {
  var { result: t, zone: e, specificOffset: r, invalidReason: n } = Br(t, e, r);
  return [t, e, r, n];
}
function Kr(s, t) {
  if (!s) return null;
  const e = g.create(t, s),
    r = e.formatDateTimeParts((Pr = Pr || L.fromMillis(1555555555555)));
  return r.map((e) => {
    {
      var r = s,
        { type: e, value: n } = e;
      ...
      n = r[e];
      let t = Jr[e];
      return (t = "object" == typeof t ? t[n] : t) ? { literal: !1, val: t } : void 0;
    }
  });
}
const Xr = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334],
  tn = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335];
function Z(t, e) {
  return new w(
    "unit out of range",
...
function sn(t) {
  ...
  let i = Math.floor((s - r + 10) / 7),
    a;
  return (
    i < 1 ? ((a = e - 1), (i = re(a))) : i > re(e) ? ((a = e + 1), (i = 1)) : (a = e),
...
function an(t) {
  ...
  let a = 7 * r + n - s - 3,
    o;
  a < 1 ? ((o = e - 1), (a += Xt(o))) : a > i ? ((o = e + 1), (a -= Xt(e))) : (o = e);
  var { month: r, day: n } = nn(o, a);
  return { year: o, month: r, day: n, ...le(t) };
}
function on(t) {
  var { year: e, month: r, day: n } = t;
  return { year: e, ordinal: rn(e, r, n), ...le(t) };
}
function un(t) {
  var { year: e, ordinal: r } = t,
    { month: r, day: n } = nn(e, r);
...
function ln(t) {
  var e = Rt(t.weekYear),
    ...
    n = u(t.weekday, 1, 7);
  return e ? (r ? !n && Z("weekday", t.weekday) : Z("week", t.week)) : Z("weekYear", t.weekYear);
}
function cn(t) {
  var e = Rt(t.year),
...
function hn(t) {
  ...
  return e ? (r ? !n && Z("day", t.day) : Z("month", t.month)) : Z("year", t.year);
}
function dn(t) {
  var { hour: t, minute: e, second: r, millisecond: n } = t,
    ...
    a = u(r, 0, 59),
    o = u(n, 0, 999);
  return s ? (i ? (a ? !o && Z("millisecond", n) : Z("second", r)) : Z("minute", e)) : Z("hour", t);
}
...
function yn(t) {
  return null === t.weekData && (t.weekData = sn(t.c)), t.weekData;
}
function gn(t, e) {
...
function Tn(t, e) {
  var r = t.o,
    ...
    n = {
      ...
      year: n,
      month: s,
      day: Math.min(t.c.day, te(n, s)) + Math.trunc(e.days) + 7 * Math.trunc(e.weeks),
    },
    s = D.fromObject({
...
function Sn(t, e, r, n, s, i) {
  ...
  return L.invalid(new w("unparsable", `the input "${s}" can't be parsed as ` + n));
}
function On(t, e, r = !0) {
  return t.isValid
    ? g.create(O.create("en-US"), { allowZ: r, forceSimple: !0 }).formatDateTimeFromString(t, e)
    : null;
}
function bn(t, e) {
  ...
  return (
    r && 0 <= t.c.year && (n += "+"),
    (n += l(t.c.year, r ? 6 : 4)),
    (n = e ? (n = (n += "-") + l(t.c.month) + "-") + l(t.c.day) : (n += l(t.c.month)) + l(t.c.day))
  );
}
function kn(t, e, r, n, s, i) {
  let a = l(t.c.hour);
  return (
    e
...
const Mn = { month: 1, day: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
  Nn = { weekNumber: 1, weekday: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
...
function Cn(t, e) {
  ...
  if (M(t.year)) i = s;
    ...
    for (const o of En) M(t[o]) && (t[o] = Mn[o]);
    e = hn(t) || dn(t);
...
class L {
  constructor(t) {
    ...
    let r =
        t.invalid ||
        (Number.isNaN(t.ts) ? new w("invalid input") : null) ||
        (e.isValid ? null : fn(e)),
    ...
    r ||
      (t.old && t.old.ts === this.ts && t.old.zone.equals(e)
        ...
        : ((i = e.offset(this.ts)),
          (n = vn(this.ts, i)),
          (r = Number.isNaN(n.year) ? new w("invalid input") : null),
          (n = r ? null : n),
          (s = r ? null : i))),
      (this._zone = e),
      (this.loc = t.loc || O.create()),
  ...
  static local() {
    var [t, e] = Zn(arguments),
      [e, r, n, s, i, a, o] = e;
    return Cn({ year: e, month: r, day: n, hour: s, minute: i, second: a, millisecond: o }, t);
  }
  static utc() {
    const [t, e] = Zn(arguments),
      [r, n, s, i, a, o, u] = e;
    return (
      (t.zone = d.utcInstance),
      Cn({ year: r, month: n, day: s, hour: i, minute: a, second: o, millisecond: u }, t)
    );
  }
  static fromJSDate(t, e = {}) {
    ...
    return r.isValid ? new L({ ts: t, zone: r, loc: O.fromObject(e) }) : L.invalid(fn(r));
  }
  static fromMillis(t, e = {}) {
    if (c(t))
      return t < -864e13 || 864e13 < t
        ? L.invalid("Timestamp out of range")
        : new L({ ts: t, zone: b(e.zone, k.defaultZone), loc: O.fromObject(e) });
    throw new o(
      `fromMillis requires a numerical input, but received a ${typeof t} with value ` + t
    );
  }
  static fromSeconds(t, e = {}) {
    if (c(t)) return new L({ ts: 1e3 * t, zone: b(e.zone, k.defaultZone), loc: O.fromObject(e) });
    throw new o("fromSeconds requires a numerical input");
  }
  static fromObject(t, e = {}) {
    t = t || {};
    const r = b(e.zone, k.defaultZone);
    if (!r.isValid) return L.invalid(fn(r));
    const n = k.now(),
    ...
    var g = (e ? ln : a ? cn : hn)(i) || dn(i);
    if (g) return L.invalid(g);
    const w = e ? an(i) : a ? un(i) : i,
      [v, p] = pn(w, s, r),
      T = new L({ ts: v, zone: r, o: p, loc: h });
    return i.weekday && l && t.weekday !== T.weekday
      ? L.invalid(
          "mismatched weekday",
          `you can't specify both a weekday of ${i.weekday} and a date of ` + T.toISO()
        )
      : T;
  }
  static fromISO(t, e = {}) {
    var [r, n] = sr(t);
    return Sn(r, n, e, "ISO 8601", t);
  }
  static fromRFC2822(t, e = {}) {
    var [r, n] = ir(t);
    return Sn(r, n, e, "RFC 2822", t);
  }
  static fromHTTP(t, e = {}) {
    var [t, r] = ar(t);
    return Sn(t, r, e, "HTTP", e);
  }
  static fromFormat(t, e, r = {}) {
    if (M(t) || M(e)) throw new o("fromFormat requires an input string and a format");
    var { locale: n = null, numberingSystem: s = null } = r,
      [n, s, i, a] = Qr(O.fromOpts({ locale: n, numberingSystem: s, defaultToEN: !0 }), t, e);
    return a ? L.invalid(a) : Sn(n, s, r, "format " + e, t, i);
  }
  ...
  static parseFormatForOpts(t, e = {}) {
    const r = Kr(t, O.fromObject(e));
    return r ? r.map((t) => (t ? t.val : null)).join("") : null;
  }
  static expandFormat(t, e = {}) {
    const r = Gr(g.parseFormat(t), O.fromObject(e));
  ...
  get monthShort() {
    return this.isValid ? Mr.months("short", { locObj: this.loc })[this.month - 1] : null;
  }
  get monthLong() {
    return this.isValid ? Mr.months("long", { locObj: this.loc })[this.month - 1] : null;
  }
  get weekdayShort() {
    return this.isValid ? Mr.weekdays("short", { locObj: this.loc })[this.weekday - 1] : null;
  }
  get weekdayLong() {
    return this.isValid ? Mr.weekdays("long", { locObj: this.loc })[this.weekday - 1] : null;
  }
  get offset() {
  ...
  resolvedLocaleOptions(t = {}) {
    var {
      ...
      numberingSystem: e,
      calendar: r,
    } = g.create(this.loc.clone(t), t).resolvedOptions(this);
  ...
  set(t) {
    ...
    e
      ...
      : (a = un({ ...on(this.c), ...t }));
    var [n, i] = pn(a, this.o, this.zone);
    return gn(this, { ts: n, o: i });
  }
  plus(t) {
    return this.isValid ? gn(this, Tn(this, D.fromDurationLike(t))) : this;
  }
  minus(t) {
    return this.isValid ? gn(this, Tn(this, D.fromDurationLike(t).negate())) : this;
  }
  startOf(t) {
    if (!this.isValid) return this;
    const e = {},
    ...
    return (
      "weeks" === r && (e.weekday = 1),
      "quarters" === r && ((t = Math.ceil(this.month / 3)), (e.month = 3 * (t - 1) + 1)),
      this.set(e)
    );
  }
  endOf(t) {
  ...
  toFormat(t, e = {}) {
    return this.isValid
      ? g.create(this.loc.redefaultToEN(e)).formatDateTimeFromString(this, t)
      : mn;
  }
  toLocaleString(t = U, e = {}) {
    return this.isValid ? g.create(this.loc.clone(e), t).formatDateTime(this) : mn;
  }
  toLocaleParts(t = {}) {
    return this.isValid ? g.create(this.loc.clone(t), t).formatDateTimeParts(this) : [];
  }
  toISO({
    format: t = "extended",
    suppressSeconds: e = !1,
  ...
  toISOTime({
    ...
    return this.isValid ? (n ? "T" : "") + kn(this, "extended" === i, e, t, r, s) : null;
  }
  toRFC2822() {
  ...
  toSQLTime({ includeOffset: t = !0, includeZone: e = !1, includeOffsetSpace: r = !0 } = {}) {
    let n = "HH:mm:ss.SSS";
    return (e || t) && (r && (n += " "), e ? (n += "z") : t && (n += "ZZ")), On(this, n, !0);
  }
  toSQL(t = {}) {
  ...
  diff(t, e = "milliseconds", r = {}) {
    if (!this.isValid || !t.isValid) return D.invalid("created by diffing an invalid DateTime");
    r = { locale: this.locale, numberingSystem: this.numberingSystem, ...r };
    const n = Pt(e).map(D.normalizeUnit),
  ...
  until(t) {
    return this.isValid ? E.fromDateTimes(this, t) : this;
  }
  hasSame(t, e) {
  ...
  toRelative(t = {}) {
    ...
    return (
      ...
      Fn(e, this.plus(r), { ...t, numeric: "always", units: n, unit: s })
    );
  }
  toRelativeCalendar(t = {}) {
    return this.isValid
      ? Fn(t.base || L.fromObject({}, { zone: this.zone }), this, {
          ...t,
          numeric: "auto",
  ...
  static fromFormatExplain(t, e, r = {}) {
    ...
    return Br(O.fromOpts({ locale: r, numberingSystem: n, defaultToEN: !0 }), t, e);
  }
