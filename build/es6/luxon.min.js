...
const U = { year: e, month: e, day: e },
  ...
  Y = { year: e, month: s, day: e, weekday: s },
  R = { hour: e, minute: e },
...
class O {
  ...
  constructor(t, e, r, n) {
    ...
    (this.locale = t),
      ...
      (this.intl = xt(this.locale, this.numberingSystem, this.outputCalendar)),
  ...
  months(r, n = !1, t = !0) {
    return It(this, r, t, me, () => {
      ...
      return (
        this.monthsCache[t][r] || (this.monthsCache[t][r] = Et((t) => this.extract(t, e, "month"))),
    ...
    return It(this, r, t, we, () => {
      ...
      return (
        this.weekdaysCache[t][r] ||
          (this.weekdaysCache[t][r] = Vt((t) => this.extract(t, e, "weekday"))),
        this.weekdaysCache[t][r]
      );
    });
  }
...
var e = /(?:(Z)|([+-]\d\d)(?::?(\d\d))?)/,
  ...
  Fe = Ve("weekYear", "weekNumber", "weekDay"),
  Ze = Ve("year", "ordinal"),
...
class x {
  ...
  static fromISO(t, s) {
    ...
    return x.invalid("unparsable", `the input "${t}" can't be parsed as ISO 8601`);
  }
  static isInterval(t) {
  ...
  splitBy(t) {
    ...
    for (; r < this.e; ) {
      ...
      (s = +a > +this.e ? this.e : a), i.push(x.fromDateTimes(r, s)), (r = s), (n += 1);
    }
    return i;
  }
  divideEqually(t) {
  ...
  static xor(t) {
    ...
    for (const o of a)
      (r += "s" === o.type ? 1 : -1),
        (e = 1 === r ? o.time : (e && +e != +o.time && n.push(x.fromDateTimes(e, o.time)), null));
    return x.merge(n);
  }
  difference(...t) {
    return x
        ...
        (function (e) {
          ...
          if (isNaN(r)) {
            ...
            for (let t = 0; t < e.length; t++) {
              ...
              if (-1 !== e[t].search(xr.hanidec)) r += Vr.indexOf(e[t]);
              else
                for (const a in Er) {
                  var [s, i] = Er[a];
                  s <= n && n <= i && (r += n - s);
...
const Cr = E(),
  ...
  Hr = new RegExp($r, "g");
function Wr(t) {
  return t.replace(/\./g, "\\.?").replace(Hr, $r);
}
function Yr(t) {
...
function F(t, r) {
  return null === t
    ? null
    : { regex: t.map(Wr).join("|"), deser: ([e]) => t.findIndex((t) => Yr(e) === Yr(t)) + r };
}
function Rr(t, e) {
    ...
    ...t.map((t) => {
      {
        ...
        const r = tn(g.macroTokenToFormatOpts(t.val), e);
...
function Kr(r, t, e) {
  const n = Qr(g.parseFormat(e), r),
    s = n.map((t) => {
      t = Pr(t, r);
      if (!t.regex) return t;
      var e = "string" == typeof t.regex ? t.regex : t.regex.source;
      return { ...t, regex: e };
    }),
    i = s.find((t) => t.invalidReason);
  if (i) return { input: t, tokens: n, invalidReason: i.invalidReason };
  var [e, a] = [`^${(e = s).map((t) => t.regex).reduce((t, e) => t + `(${e})`, "")}$`, e],
    e = RegExp(e, "i"),
    [a, o] = (function (t, e, r) {
      const n = t.match(e);
      if (n) {
...
function Xr(t, e, r) {
  var { result: t, zone: e, specificOffset: r, invalidReason: n } = Kr(t, e, r);
  return [t, e, r, n];
}
function tn(s, t) {
  if (!s) return null;
  const e = g.create(t, s),
    r = e.formatDateTimeParts((Br = Br || L.fromMillis(1555555555555)));
  return r.map((e) => {
    {
      var r = s,
        { type: e, value: n } = e;
...
function un(t) {
  ...
  var { month: r, day: n } = an(o, a);
  return { year: o, month: r, day: n, ...le(t) };
}
function ln(t) {
  var { year: e, month: r, day: n } = t;
  return { year: e, ordinal: sn(e, r, n), ...le(t) };
}
function cn(t) {
  var { year: e, ordinal: r } = t,
    { month: r, day: n } = an(e, r);
...
function On(t, e) {
  ...
  let [i, a] = pn(ee(n), r, t.zone);
  return 0 !== s && ((i += s), (a = t.zone.offset(i))), { ts: i, o: a };
}
function bn(t, e, r, n, s, i) {
...
const Dn = { month: 1, day: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
  xn = { weekNumber: 1, weekday: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
  En = { ordinal: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
...
function Zn(t, e) {
  ...
  if (M(t.year)) i = s;
    ...
    for (const o of Vn) M(t[o]) && (t[o] = Dn[o]);
    e = mn(t) || fn(t);
...
class L {
  ...
  static local() {
    var [t, e] = zn(arguments),
      [e, r, n, s, i, a, o] = e;
    return Zn({ year: e, month: r, day: n, hour: s, minute: i, second: a, millisecond: o }, t);
  }
  static utc() {
    ...
    return (
      ...
      Zn({ year: r, month: n, day: s, hour: i, minute: a, second: o, millisecond: u }, t)
    );
  }
  static fromJSDate(t, e = {}) {
    t = Rt(t) ? t.valueOf() : NaN;
    if (Number.isNaN(t)) return L.invalid("invalid input");
    var r = b(e.zone, k.defaultZone);
    return r.isValid ? new L({ ts: t, zone: r, loc: O.fromObject(e) }) : L.invalid(gn(r));
  }
  static fromMillis(t, e = {}) {
    if (c(t))
  ...
  static fromObject(t, e = {}) {
    t = t || {};
    const r = b(e.zone, k.defaultZone);
    if (!r.isValid) return L.invalid(gn(r));
    const n = k.now(),
    ...
    var g = (e ? hn : a ? dn : mn)(i) || fn(i);
    if (g) return L.invalid(g);
    const w = e ? un(i) : a ? cn(i) : i,
      [v, p] = Sn(w, s, r),
  ...
  static fromISO(t, e = {}) {
    var [r, n] = sr(t);
    return bn(r, n, e, "ISO 8601", t);
  }
  static fromRFC2822(t, e = {}) {
    var [r, n] = ir(t);
    return bn(r, n, e, "RFC 2822", t);
  }
  static fromHTTP(t, e = {}) {
    var [t, r] = ar(t);
    return bn(t, r, e, "HTTP", e);
  }
  static fromFormat(t, e, r = {}) {
    ...
    var { locale: n = null, numberingSystem: s = null } = r,
      [n, s, i, a] = Xr(O.fromOpts({ locale: n, numberingSystem: s, defaultToEN: !0 }), t, e);
    return a ? L.invalid(a) : bn(n, s, r, "format " + e, t, i);
  }
  ...
  static parseFormatForOpts(t, e = {}) {
    const r = tn(t, O.fromObject(e));
    return r ? r.map((t) => (t ? t.val : null)).join("") : null;
  }
  static expandFormat(t, e = {}) {
    const r = Qr(g.parseFormat(t), O.fromObject(e));
  ...
  set(t) {
    ...
    return vn(this, { ts: n, o: i });
  }
  plus(t) {
    return this.isValid ? vn(this, On(this, D.fromDurationLike(t))) : this;
  }
  minus(t) {
    return this.isValid ? vn(this, On(this, D.fromDurationLike(t).negate())) : this;
  }
  startOf(t) {
    if (!this.isValid) return this;
    const e = {},
  ...
  toLocaleString(t = U, e = {}) {
    return this.isValid ? g.create(this.loc.clone(e), t).formatDateTime(this) : yn;
  }
  toLocaleParts(t = {}) {
  ...
  toISO({
    ...
    var t = "extended" === t,
      i = Mn(this, t);
    return (i += "T") + Nn(this, t, e, r, n, s);
  }
  toISODate({ format: t = "extended" } = {}) {
    return this.isValid ? Mn(this, "extended" === t) : null;
  }
  toISOWeekDate() {
  ...
  toISOTime({
    ...
    return this.isValid ? (n ? "T" : "") + Nn(this, "extended" === i, e, t, r, s) : null;
  }
  toRFC2822() {
  ...
  toSQLTime({ includeOffset: t = !0, includeZone: e = !1, includeOffsetSpace: r = !0 } = {}) {
    let n = "HH:mm:ss.SSS";
    return (e || t) && (r && (n += " "), e ? (n += "z") : t && (n += "ZZ")), kn(this, n, !0);
  }
  toSQL(t = {}) {
  ...
  toRelative(t = {}) {
    ...
    return (
      ...
      Ln(e, this.plus(r), { ...t, numeric: "always", units: n, unit: s })
    );
  }
  toRelativeCalendar(t = {}) {
    return this.isValid
      ? Ln(t.base || L.fromObject({}, { zone: this.zone }), this, {
          ...t,
          numeric: "auto",
  ...
  static fromFormatExplain(t, e, r = {}) {
    ...
    return Kr(O.fromOpts({ locale: r, numberingSystem: n, defaultToEN: !0 }), t, e);
  }
