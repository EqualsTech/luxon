define(["exports"], function (e) {
  ...
  function o(e, t, n) {
    t && A(e.prototype, t), n && A(e, n), Object.defineProperty(e, "prototype", { writable: !1 });
  }
  function f() {
  ...
  function _(e) {
    ...
    return (function (e) {
      ...
      function t() {
        return q(e, arguments, j(this).constructor);
      }
      return (
  ...
  var t = (function (e) {
    ...
    ge = {};
  var we = { year: 0, month: 1, day: 2, era: 3, hour: 4, minute: 5, second: 6 };
  var ke = {},
    d = (function (n) {
      function r(e) {
      ...
      return (
        (e.offsetName = function (e, t) {
          return Xe(e, t.format, t.locale, this.name);
        }),
              ...
              ? (function (e, t) {
                  for (var n = e.formatToParts(t), r = [], i = 0; i < n.length; i++) {
                    var o = n[i],
                      ...
                      o = o.value,
                      u = we[a];
                    "era" === a ? (r[u] = o) : T(u) || (r[u] = parseInt(o, 10));
                  }
                  return r;
                })(t, e)
              : ((r = e),
                (t = (t = t).format(r).replace(/\u200E/g, "")),
                (t = (r = /(\d+)\/(\d+)\/(\d+) (AD|BC),? (\d+):(\d+):(\d+)/.exec(t))[1]),
                (n = r[2]),
                [r[3], t, n, r[4], r[5], r[6], r[7]]),
            n = t[0],
            r = t[1],
            i = t[2],
            o = t[3],
  ...
  function Me(e, t) {
    ...
    var n = JSON.stringify([e, t]),
      r = Oe[n];
    return r || ((r = new Intl.DateTimeFormat(e, t)), (Oe[n] = r)), r;
  }
  var Ne = {};
  var De = {};
  var Ee = null;
  ...
  var Ie = (function () {
      function e(e, t, n) {
        ...
        (!t || 0 < Object.keys(r).length) &&
          ...
          (this.inf =
            ...
            (t = Ne[e]) || ((t = new Intl.NumberFormat(r, n)), (Ne[e] = t)),
            t)));
      }
      return (
        (e.prototype.format = function (e) {
          ...
          return this.inf
            ...
            : c(this.floor ? Math.floor(e) : Ye(e, 3), this.padTo);
        }),
        e
      );
    })(),
    xe = (function () {
      function e(e, t, n) {
        ...
        var r,
          i = f({}, this.opts);
        r && (i.timeZone = r), (this.dtf = Me(t, i));
      }
      var t = e.prototype;
      return (
        (t.format = function () {
        ...
        (this.opts = f({ style: "long" }, n)),
          !t &&
            ...
            (this.rtf =
              ...
              (r = De[n]) || ((r = new Intl.RelativeTimeFormat(t, e)), (De[n] = r)),
              r));
      }
      var t = e.prototype;
      return (
    ...
    w = (function () {
      function i(e, t, n, r) {
        var e = (function (e) {
            ...
            var t,
              n = e.substring(0, n);
            try {
              t = Me(e).resolvedOptions();
            } catch (e) {
              t = Me(n).resolvedOptions();
            }
      ...
      (i.fromOpts = function (e) {
        ...
        (i.create = function (e, t, n, r) {
          ...
          e = e || b.defaultLocale;
          return new i(
            e || (r ? "en-US" : (Ee = Ee || new Intl.DateTimeFormat().resolvedOptions().locale)),
            t || b.defaultNumberingSystem,
            n || b.defaultOutputCalendar,
            e
          );
        }),
      ...
      return (
        ...
        (e.redefaultToEN = function (e) {
          return this.clone(f({}, (e = void 0 === e ? {} : e), { defaultToEN: !0 }));
        }),
        (e.redefaultToSystem = function (e) {
          return this.clone(f({}, (e = void 0 === e ? {} : e), { defaultToEN: !1 }));
        }),
        (e.months = function (n, r, e) {
          var i = this;
          return (
            void 0 === r && (r = !1),
            Ve(this, n, (e = void 0 === e ? !0 : e), st, function () {
        ...
        (e.weekdays = function (n, r, e) {
          ...
          return (
            void 0 === r && (r = !1),
            Ve(this, n, (e = void 0 === e ? !0 : e), dt, function () {
              var t = r
        ...
        (e.eras = function (e, t) {
          var n = this;
          return Ve(this, e, (t = void 0 === t ? !0 : t), pt, function () {
            var t = { era: e };
            return (
              n.eraCache[e] ||
        ...
        (e.numberFormatter = function (e) {
          return new Ie(this.intl, (e = void 0 === e ? {} : e).forceSimple || this.fastNumbers, e);
        }),
        (e.dtFormatter = function (e, t) {
          return new xe(e, this.intl, (t = void 0 === t ? {} : t));
        }),
        ...
        (e.listFormatter = function (e) {
          return (
            ...
            (r = Se[n]) || ((r = new Intl.ListFormat(t, e)), (Se[n] = r)),
            r
          );
          var t, n, r;
        }),
        ...
        o(
          ...
          [
            ...
            },
            {
              key: "name",
              get: function () {
                return 0 === this.fixed ? "UTC" : "UTC" + rt(this.fixed, "narrow");
              },
            },
            {
              key: "ianaName",
              get: function () {
                return 0 === this.fixed ? "Etc/UTC" : "Etc/GMT" + rt(-this.fixed, "narrow");
              },
            },
            {
              key: "isUniversal",
  ...
  function l(e) {
    if (!T(e) && null !== e && "" !== e) return parseInt(e, 10);
  }
  function m(e) {
    if (!T(e) && null !== e && "" !== e) return parseFloat(e);
  }
  function Re(e) {
    if (!T(e) && null !== e && "" !== e) return (e = 1e3 * parseFloat("0." + e)), Math.floor(e);
  }
  function Ye(e, t, n) {
    void 0 === n && (n = !1);
    t = Math.pow(10, t);
  ...
  function Ke(e) {
    return 99 < e ? e : e > b.twoDigitCutoffYear ? 1900 + e : 2e3 + e;
  }
  function Xe(e, t, n, r) {
    void 0 === r && (r = null);
    var e = new Date(e),
      ...
      r = (r && (i.timeZone = r), f({ timeZoneName: t }, i)),
  ...
  function nt(e, t) {
    var n,
      r,
      i = {};
    for (n in e) !v(e, n) || (null != (r = e[n]) && (i[t(n)] = tt(r)));
    return i;
  }
  function rt(e, t) {
      ...
      return (
        (e.formatWithSystemDefault = function (e, t) {
          return (
            ...
            this.systemLoc.dtFormatter(e, f({}, this.opts, t)).format()
          );
        }),
        (e.formatDateTime = function (e, t) {
          return this.loc.dtFormatter(e, f({}, this.opts, (t = void 0 === t ? {} : t))).format();
        }),
        (e.formatDateTimeParts = function (e, t) {
          return this.loc
            .dtFormatter(e, f({}, this.opts, (t = void 0 === t ? {} : t)))
            .formatToParts();
        }),
        ...
        (e.formatDateTimeFromString = function (r, e) {
          var n = this,
            ...
            f = function (e) {
              return i ? ((t = r), pt(e)[t.year < 0 ? 0 : 1]) : o({ era: e }, "era");
              var t;
            };
          return gt(d.parseFormat(e), function (e) {
            switch (e) {
              case "S":
  ...
  var t = /(?:(Z)|([+-]\d\d)(?::?(\d\d))?)/,
    ...
    Ot = RegExp(a.source + ("(?:" + t.source + "?(?:\\[(" + r.source + ")\\])?)?")),
    p = RegExp("(?:T" + Ot.source + ")?"),
    Mt = St("weekYear", "weekNumber", "weekDay"),
    Nt = St("year", "ordinal"),
  ...
  function Vt(e, t) {
    var n = !e[t] && !e[t + 1],
      e = et(e[t + 1], e[t + 2]);
    return [{}, n ? null : h.instance(e), t + 3];
  }
  function It(e, t) {
    return [{}, e[t] ? d.create(e[t]) : null, t + 1];
  }
  ...
  function Lt(e, t, n, r, i, o, a) {
    t = {
      year: 2 === t.length ? Ke(l(t)) : l(t),
      month: at.indexOf(n) + 1,
      day: l(r),
      hour: l(i),
      minute: l(o),
    };
    return (
      a && (t.second = l(a)),
      e && (t.weekday = 3 < e.length ? ct.indexOf(e) + 1 : lt.indexOf(e) + 1),
      t
    );
  }
  var At =
  ...
  function Ut(e) {
    var t = e[1],
      n = e[2],
      r = e[3];
    return [Lt(t, e[4], r, n, e[5], e[6], e[7]), h.utcInstance];
  }
  function Pt(e) {
    var t = e[1],
      n = e[2],
      ...
      o = e[5],
      a = e[6];
    return [Lt(t, e[7], n, r, i, o, a), h.utcInstance];
  }
  var Ht = kt(/([+-]\d{6}|\d{4})(?:-?(\d\d)(?:-?(\d\d))?)?/, p),
    Wt = kt(/(\d{4})-?W(\d\d)(?:-?(\d))?/, p),
    Rt = kt(/(\d{4})-?(\d{3})/, p),
    Yt = kt(Ot),
    Jt = bt(
      function (e, t) {
        return [{ year: Dt(e, t), month: Dt(e, t + 1, 1), day: Dt(e, t + 2, 1) }, null, t + 3];
      },
      Et,
      Vt,
      It
  ...
  var a = {
    ...
    rn = N.slice(0).reverse();
  function D(e, t, n) {
    n = {
      values: (n = void 0 === n ? !1 : n) ? t.values : f({}, e.values, t.values || {}),
  ...
  var E = (function () {
      ...
      (m.fromMillis = function (e, t) {
        ...
        (m.invalid = function (e, t) {
          ...
          e = e instanceof M ? e : new M(e, t);
          if (b.throwOnInvalid) throw new R(e);
      ...
      return (
        (e.toFormat = function (e, t) {
          t = f({}, (t = void 0 === t ? {} : t), { floor: !1 !== t.round && !1 !== t.floor });
          return this.isValid
            ? O.create(this.loc, t).formatDurationFromString(this, e)
            : "Invalid Duration";
        }),
        (e.toHuman = function (n) {
            ...
            e =
              ...
              N.map(function (e) {
                ...
                return T(t)
                  ...
                  : r.loc
                      .numberFormatter(
                        f({ style: "unit", unitDisplay: "long" }, n, { unit: e.slice(0, -1) })
                      )
                      .format(t);
              }).filter(function (e) {
                return e;
          ...
          return this.loc
            .listFormatter(f({ type: "conjunction", style: n.listStyle || "narrow" }, n))
            .format(e);
        }),
        (e.toObject = function () {
        ...
        (e.plus = function (e) {
          ...
          for (var t = m.fromDurationLike(e), n = {}, r = g(N); !(i = r()).done; ) {
            var i = i.value;
            (v(t.values, i) || v(this.values, i)) && (n[i] = t.get(i) + this.get(i));
          }
        ...
        (e.set = function (e) {
          return this.isValid
            ? D(this, { values: f({}, this.values, nt(e, m.normalizeUnit)) })
            : this;
        }),
        (e.reconfigure = function (e) {
          ...
          return D(this, { loc: t, matrix: e, conversionAccuracy: r });
        }),
        (e.as = function (e) {
        ...
        (e.normalize = function () {
          ...
          return (
            (n = this.matrix),
            (r = e),
            rn.reduce(function (e, t) {
              return T(r[t]) ? e : (e && on(n, r, e, r, t), t);
            }, null),
            D(this, { values: e }, !0)
          );
        }),
          ...
          for (
            ...
            if (0 <= t.indexOf(s)) {
              ...
              for (d in ((i[s] = h), (o[s] = (1e3 * f - 1e3 * h) / 1e3), a))
                N.indexOf(d) > N.indexOf(s) && on(this.matrix, a, d, i, s);
            } else y(a[s]) && (o[s] = a[s]);
          }
          for (r in o) 0 !== o[r] && (i[l] += r === l ? o[r] : o[r] / this.matrix[l][r]);
          return D(this, { values: i }, !0).normalize();
        }),
  ...
  var un = (function () {
      ...
      (c.invalid = function (e, t) {
        ...
        e = e instanceof M ? e : new M(e, t);
        if (b.throwOnInvalid) throw new W(e);
      ...
      return (
        ...
        (e.toISOTime = function (e) {
          return this.isValid ? this.s.toISOTime(e) + "/" + this.e.toISOTime(e) : an;
        }),
        (e.toFormat = function (e, t) {
          (t = (void 0 === t ? {} : t).separator), (t = void 0 === t ? " – " : t);
          return this.isValid ? "" + this.s.toFormat(e) + t + this.e.toFormat(e) : an;
        }),
    ...
    sn = (function () {
      ...
      return (
        ...
        (e.months = function (e, t) {
          ...
          return (
            i ||
            w.create(void 0 === n ? null : n, void 0 === r ? null : r, void 0 === t ? "gregory" : t)
          ).months(e);
        }),
        ...
        (e.weekdays = function (e, t) {
          ...
          return (
            (void 0 === t ? null : t) ||
            w.create(void 0 === n ? null : n, void 0 === r ? null : r, null)
          ).weekdays(e);
        }),
        ...
        (e.meridiems = function (e) {
          e = (void 0 === e ? {} : e).locale;
          return w.create(void 0 === e ? null : e).meridiems();
        }),
        (e.eras = function (e, t) {
          void 0 === e && (e = "short");
          t = (void 0 === t ? {} : t).locale;
          return w.create(void 0 === t ? null : t, null, "gregory").eras(e);
        }),
        (e.features = function () {
          return { relative: He() };
        }),
  ...
  var yn = V(),
    ...
    Sn = V("{4,6}"),
    On = /[\-\[\]{}()*+?.,\\\^$|#\s]/g,
    Mn = "[ " + String.fromCharCode(160) + "]",
    Nn = new RegExp(Mn, "g");
  function Dn(e) {
    return e.replace(/\./g, "\\.?").replace(Nn, Mn);
  }
  function En(e) {
  ...
  function xn(t, n) {
    ...
    var e = (function (e) {
      ...
      switch (e.val) {
        ...
        case "Z":
        case "ZZ":
          return Vn(new RegExp("([+-]" + C.source + ")(?::(" + x.source + "))?"), 2);
        case "ZZZ":
          return Vn(new RegExp("([+-]" + C.source + ")(" + x.source + ")?"), 2);
        case "z":
    ...
    return (t = Array.prototype).concat.apply(
      ...
      e.map(function (e) {
        return (
          (t = n),
          (e = e).literal ||
          null == (t = An(O.macroTokenToFormatOpts(e.val), t)) ||
          t.includes(void 0)
            ? e
            : t
        );
  ...
  function Ln(t, e, n) {
    var n = Zn(O.parseFormat(n), t),
      r = n.map(function (e) {
        return (e = xn(e, t)).regex
          ? f({}, e, { regex: "string" == typeof e.regex ? e.regex : e.regex.source })
          : e;
      }),
      i = r.find(function (e) {
    ...
    var o,
      ...
      u = i
        ? ((u = null),
          T((o = i).z) || (u = d.create(o.z)),
          T(o.Z) || ((u = u || new h(o.Z)), (s = o.Z)),
          T(o.q) || (o.M = 3 * (o.q - 1) + 1),
          T(o.h) || (o.h < 12 && 1 === o.a ? (o.h += 12) : 12 === o.h && 0 === o.a && (o.h = 0)),
          0 === o.G && o.y && (o.y = -o.y),
          T(o.u) || (o.S = Re(o.u)),
          [
  ...
  function An(r, e) {
    return r
      ? O.create(e, r)
          .formatDateTimeParts((Fn = Fn || L.fromMillis(1555555555555)))
          .map(function (e) {
            return (
              (t = r),
              (n = (e = e).type),
  ...
  var jn = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334],
  ...
  function Pn(e) {
    ...
    return (
      i < 1 ? (i = Qe((t = n - 1))) : i > Qe(n) ? ((t = n + 1), (i = 1)) : (t = n),
      f({ weekYear: t, weekNumber: i, weekday: r }, it(e))
    );
  }
  function Hn(e) {
    var t,
      ...
      r = 7 * r + i - o - 3,
      i =
        (r < 1 ? (r += Ge((t = n - 1))) : a < r ? ((t = n + 1), (r -= Ge(n))) : (t = n), Un(t, r));
    return f({ year: t, month: i.month, day: i.day }, it(e));
  }
  function Wn(e) {
    var t = e.year;
    return f({ year: t, ordinal: _n(t, e.month, e.day) }, it(e));
  }
  function Rn(e) {
    var t = e.year,
      n = Un(t, e.ordinal);
    return f({ year: t, month: n.month, day: n.day }, it(e));
  }
  function Yn(e) {
    var t = Pe(e.year),
      n = S(e.month, 1, 12),
      r = S(e.day, 1, $e(e.year, e.month));
  ...
  function $n(e) {
    return new M("unsupported zone", 'the zone "' + e.name + '" is not supported');
  }
  function Bn(e) {
    return null === e.weekData && (e.weekData = Pn(e.c)), e.weekData;
  }
  function Qn(e, t) {
    e = { ts: e.ts, zone: e.zone, c: e.c, o: e.o, loc: e.loc, invalid: e.invalid };
    return new L(f({}, e, t, { old: e }));
  }
  function Kn(e, t, n) {
    var r = e - 60 * t * 1e3,
      i = n.offset(r);
  ...
  function nr(e, t, n, r, i, o) {
    ...
    return e && 0 !== Object.keys(e).length
      ? ((e = L.fromObject(e, f({}, n, { zone: t || u, specificOffset: o }))), a ? e : e.setZone(u))
      : L.invalid(new M("unparsable", 'the input "' + i + "\" can't be parsed as " + r));
  }
  function rr(e, t, n) {
    return (
      void 0 === n && (n = !0),
      e.isValid
        ? O.create(w.create("en-US"), { allowZ: n, forceSimple: !0 }).formatDateTimeFromString(e, t)
        : null
    );
  }
  function ir(e, t) {
    ...
    return (
      ...
      (r += c(e.c.year, n ? 6 : 4)),
      (r = t
        ? (r = (r += "-") + c(e.c.month) + "-") + c(e.c.day)
        : (r += c(e.c.month)) + c(e.c.day))
    );
  }
  function or(e, t, n, r, i, o) {
    ...
    return (
      t
        ? ((a = (a += ":") + c(e.c.minute)), (0 === e.c.second && n) || (a += ":"))
        : (a += c(e.c.minute)),
      (0 === e.c.second && n) ||
        ((a += c(e.c.second)),
        (0 === e.c.millisecond && r) || (a = (a += ".") + c(e.c.millisecond, 3))),
      i &&
        (e.isOffsetFixed && 0 === e.offset && !o
          ? (a += "Z")
          : (a =
              e.o < 0
                ? (a = (a += "-") + c(Math.trunc(-e.o / 60)) + ":") + c(Math.trunc(-e.o % 60))
                : (a = (a += "+") + c(Math.trunc(e.o / 60)) + ":") + c(Math.trunc(e.o % 60)))),
      o && (a += "[" + e.zone.ianaName + "]"),
      a
    );
  }
  var ar = { month: 1, day: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
    ur = { weekNumber: 1, weekday: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
    sr = { ordinal: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
    cr = ["year", "month", "day", "hour", "minute", "second", "millisecond"],
    lr = ["weekYear", "weekNumber", "weekday", "hour", "minute", "second", "millisecond"],
    fr = ["year", "ordinal", "hour", "minute", "second", "millisecond"];
  function dr(e) {
    var t = {
      year: "year",
      years: "year",
  ...
  function hr(e, t) {
    var n = k(t.zone, b.defaultZone),
      t = w.fromObject(t),
      r = b.now();
    if (T(e.year)) u = r;
    else {
      for (var i = g(cr); !(o = i()).done; ) {
        var o = o.value;
        T(e[o]) && (e[o] = ar[o]);
      }
      var a = Yn(e) || Jn(e);
      if (a) return L.invalid(a);
      var a = er(e, n.offset(r), n),
        u = a[0],
        a = a[1];
    }
    return new L({ ts: u, zone: n, loc: t, o: a });
  }
  function mr(t, n, r) {
    function e(e, t) {
      return (e = Ye(e, o || r.calendary ? 0 : 2, !0)), n.loc.clone(r).relFormatter(r).format(e, t);
    }
    function i(e) {
      return r.calendary
        ? n.hasSame(t, e)
  ...
  var L = (function () {
    function p(e) {
      var t,
        n = e.zone || b.defaultZone,
        r =
          e.invalid ||
          (Number.isNaN(e.ts) ? new M("invalid input") : null) ||
          (n.isValid ? null : $n(n)),
        i = ((this.ts = T(e.ts) ? b.now() : e.ts), null),
        o = null;
      r ||
        (o =
          e.old && e.old.ts === this.ts && e.old.zone.equals(n)
            ...
            : ((t = n.offset(this.ts)),
              (i = Xn(this.ts, t)),
              (i = (r = Number.isNaN(i.year) ? new M("invalid input") : null) ? null : i),
              r ? null : t)),
        (this._zone = n),
        (this.loc = e.loc || w.create()),
        (this.invalid = r),
    ...
    (p.now = function () {
      ...
      (p.utc = function () {
        var e = yr(arguments),
          ...
          e = e[6];
        return (
          (t.zone = h.utcInstance),
          hr({ year: n, month: r, day: i, hour: o, minute: a, second: u, millisecond: e }, t)
        );
      }),
      (p.fromJSDate = function (e, t) {
        ...
        var n = k(t.zone, b.defaultZone);
        return n.isValid ? new p({ ts: e, zone: n, loc: w.fromObject(t) }) : p.invalid($n(n));
      }),
      (p.fromMillis = function (e, t) {
        if ((void 0 === t && (t = {}), y(e)))
          return e < -864e13 || 864e13 < e
            ? p.invalid("Timestamp out of range")
            : new p({ ts: e, zone: k(t.zone, b.defaultZone), loc: w.fromObject(t) });
        throw new u(
      ...
      (p.fromSeconds = function (e, t) {
        if ((void 0 === t && (t = {}), y(e)))
          return new p({ ts: 1e3 * e, zone: k(t.zone, b.defaultZone), loc: w.fromObject(t) });
        throw new u("fromSeconds requires a numerical input");
      }),
      (p.fromObject = function (e, t) {
        e = e || {};
        var n = k((t = void 0 === t ? {} : t).zone, b.defaultZone);
        if (!n.isValid) return p.invalid($n(n));
        var r = b.now(),
          i = T(t.specificOffset) ? n.offset(r) : t.specificOffset,
          o = nt(e, dr),
          a = !T(o.ordinal),
          u = !T(o.year),
          s = !T(o.month) || !T(o.day),
        ...
        for (
          ...
          var m = m.value;
          T(o[m]) ? (o[m] = (d ? l : f)[m]) : (d = !0);
        }
        var y,
          c =
            (s
              ? ((r = Pe((c = o).weekYear)),
                (v = S(c.weekNumber, 1, Qe(c.weekYear))),
                (y = S(c.weekday, 1, 7)),
                r
                  ? v
      ...
      (p.fromISO = function (e, t) {
        void 0 === t && (t = {});
        var n = Tt(e, [Ht, Jt], [Wt, Gt], [Rt, $t], [Yt, Bt]);
      ...
      (p.fromHTTP = function (e, t) {
        void 0 === t && (t = {});
        e = Tt(e, [zt, Ut], [qt, Ut], [_t, Pt]);
        return nr(e[0], e[1], t, "HTTP", t);
      }),
      (p.fromFormat = function (e, t, n) {
        if ((void 0 === n && (n = {}), T(e) || T(t)))
        ...
        var r = n,
          ...
          i = [(r = Ln((r = i), e, t)).result, r.zone, r.specificOffset, r.invalidReason],
          r = i[0],
          o = i[1],
          a = i[2],
          i = i[3];
        return i ? p.invalid(i) : nr(r, o, n, "format " + t, e, a);
      }),
      ...
      (p.invalid = function (e, t) {
        ...
        e = e instanceof M ? e : new M(e, t);
        if (b.throwOnInvalid) throw new H(e);
      ...
      (p.parseFormatForOpts = function (e, t) {
        e = An(e, w.fromObject((t = void 0 === t ? {} : t)));
        return e
          ? e
              .map(function (e) {
                return e ? e.val : null;
      ...
      (p.expandFormat = function (e, t) {
        return (
          void 0 === t && (t = {}),
          Zn(O.parseFormat(e), w.fromObject(t))
            .map(function (e) {
              return e.val;
            })
            .join("")
    ...
    return (
      ...
      (e.resolvedLocaleOptions = function (e) {
        e = O.create(this.loc.clone((e = void 0 === e ? {} : e)), e).resolvedOptions(this);
        return { locale: e.locale, numberingSystem: e.numberingSystem, outputCalendar: e.calendar };
      }),
      (e.toUTC = function (e, t) {
        return void 0 === t && (t = {}), this.setZone(h.instance((e = void 0 === e ? 0 : e)), t);
      }),
      (e.toLocal = function () {
      ...
      (e.setZone = function (e, t) {
        var n,
          ...
          t = void 0 !== t && t;
        return (e = k(e, b.defaultZone)).equals(this.zone)
          ? this
          : e.isValid
          ? ((n = this.ts),
            (r || t) && ((r = e.offset(this.ts)), (n = er(this.toObject(), r, e)[0])),
            Qn(this, { ts: n, zone: e }))
          : p.invalid($n(e));
      }),
      (e.reconfigure = function (e) {
      ...
      (e.set = function (e) {
        ...
        var t,
          e = nt(e, dr),
          n = !T(e.weekYear) || !T(e.weekNumber) || !T(e.weekday),
          r = !T(e.ordinal),
          i = !T(e.year),
          o = !T(e.month) || !T(e.day),
        ...
        n
          ...
          : T(e.ordinal)
          ? ((t = f({}, this.toObject(), e)),
            T(e.day) && (t.day = Math.min($e(t.year, t.month), t.day)))
          : (t = Rn(f({}, Wn(this.c), e)));
        i = er(t, this.o, this.zone);
        return Qn(this, { ts: i[0], o: i[1] });
      }),
      (e.plus = function (e) {
        return this.isValid ? Qn(this, tr(this, E.fromDurationLike(e))) : this;
      }),
      (e.minus = function (e) {
        return this.isValid ? Qn(this, tr(this, E.fromDurationLike(e).negate())) : this;
      }),
      ...
      (e.toFormat = function (e, t) {
        return (
          void 0 === t && (t = {}),
          this.isValid ? O.create(this.loc.redefaultToEN(t)).formatDateTimeFromString(this, e) : Gn
        );
      }),
      (e.toLocaleString = function (e, t) {
        return (
          void 0 === e && (e = G),
          void 0 === t && (t = {}),
          this.isValid ? O.create(this.loc.clone(t), e).formatDateTime(this) : Gn
        );
      }),
      (e.toLocaleParts = function (e) {
        return (
          void 0 === e && (e = {}),
          this.isValid ? O.create(this.loc.clone(e), e).formatDateTimeParts(this) : []
        );
      }),
      (e.toISO = function (e) {
        var e = void 0 === e ? {} : e,
        ...
        var t = "extended" === (void 0 === t ? "extended" : t),
          o = ir(this, t);
        return (o += "T") + or(this, t, n, r, i, e);
      }),
      (e.toISODate = function (e) {
        e = (void 0 === e ? {} : e).format;
        return this.isValid ? ir(this, "extended" === (void 0 === e ? "extended" : e)) : null;
      }),
      ...
      (e.diff = function (e, t, n) {
        ...
        var n = f({ locale: this.locale, numberingSystem: this.numberingSystem }, n),
          t = ((t = t), (Array.isArray(t) ? t : [t]).map(E.normalizeUnit)),
          r = e.valueOf() > this.valueOf(),
          e = ln(r ? this : e, r ? e : this, t, n);
        return r ? e.negate() : e;
      }),
      ...
      (e.toRelative = function (e) {
        ...
        return (
          ...
          mr(t, this.plus(n), f({}, e, { numeric: "always", units: r, unit: i }))
        );
      }),
        ...
        return (
          ...
          this.isValid
            ? mr(
                ...
                this,
                f({}, e, { numeric: "auto", units: ["years", "months", "days"], calendary: !0 })
              )
            : null
        );
      }),
      ...
      o(
        ...
        [
          ...
          },
          {
            key: "monthShort",
            get: function () {
              return this.isValid ? sn.months("short", { locObj: this.loc })[this.month - 1] : null;
            },
          },
          {
            key: "monthLong",
            get: function () {
              return this.isValid ? sn.months("long", { locObj: this.loc })[this.month - 1] : null;
            },
          },
          {
            key: "weekdayShort",
            get: function () {
              return this.isValid
                ? sn.weekdays("short", { locObj: this.loc })[this.weekday - 1]
                : null;
            },
          },
          {
            ...
            get: function () {
              return this.isValid
                ? sn.weekdays("long", { locObj: this.loc })[this.weekday - 1]
                : null;
            },
          },
          {
