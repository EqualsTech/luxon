define(["exports"], function (e) {
  ...
  function nt(e, t) {
    var n,
      r,
      i = {};
    for (n in e) !h(e, n) || (null != (r = e[n]) && (i[t(n)] = tt(r)));
    return i;
  }
  function rt(e, t) {
  ...
  function Ut(e) {
    var t = e[1],
      n = e[2],
      r = e[3];
    return [Lt(t, e[4], r, n, e[5], e[6], e[7]), d.utcInstance];
  }
  function Pt(e) {
    var t = e[1],
      n = e[2],
      ...
      o = e[5],
      a = e[6];
    return [Lt(t, e[7], n, r, i, o, a), d.utcInstance];
  }
  var Rt = kt(/([+-]\d{6}|\d{4})(?:-?(\d\d)(?:-?(\d\d))?)?/, p),
    Ht = kt(/(\d{4})-?W(\d\d)(?:-?(\d))?/, p),
    Wt = kt(/(\d{4})-?(\d{3})/, p),
    Yt = kt(Ot),
    Jt = bt(
      ...
      return (
        ...
        (e.plus = function (e) {
          ...
          for (var t = m.fromDurationLike(e), n = {}, r = g(N); !(i = r()).done; ) {
            var i = i.value;
            (h(t.values, i) || h(this.values, i)) && (n[i] = t.get(i) + this.get(i));
          }
        ...
        (e.set = function (e) {
          return this.isValid
            ? D(this, { values: s({}, this.values, nt(e, m.normalizeUnit)) })
            : this;
        }),
  ...
  function V(e) {
    return void 0 === e && (e = ""), new RegExp("" + fn.latn + e);
  }
  ...
  var yn = V(),
    ...
    Tn = V("{2,4}"),
    Sn = V("{4,6}"),
    On = "[ " + String.fromCharCode(160) + "]",
    Mn = new RegExp(On, "g");
  function Nn(e) {
    return e.replace(/\./g, "\\.?").replace(Mn, On);
  }
  function Dn(e) {
  ...
  function In(t, n) {
    ...
    var e = (function (e) {
      ...
      switch (e.val) {
        ...
        case "Z":
        case "ZZ":
          return En(new RegExp("([+-]" + C.source + ")(?::(" + x.source + "))?"), 2);
        case "ZZZ":
          return En(new RegExp("([+-]" + C.source + ")(" + x.source + ")?"), 2);
        case "z":
    ...
    return (t = Array.prototype).concat.apply(
      ...
      e.map(function (e) {
        return (
          (t = n),
          (e = e).literal ||
          null == (t = Ln(O.macroTokenToFormatOpts(e.val), t)) ||
          t.includes(void 0)
            ? e
            : t
        );
  ...
  function Zn(t, e, n) {
    ...
    var o,
      ...
      u = i
        ? ((u = null),
          T((o = i).z) || (u = f.create(o.z)),
          T(o.Z) || ((u = u || new d(o.Z)), (s = o.Z)),
          T(o.q) || (o.M = 3 * (o.q - 1) + 1),
  ...
  function Ln(r, e) {
    return r
      ? O.create(e, r)
          .formatDateTimeParts((Cn = Cn || L.fromMillis(1555555555555)))
          .map(function (e) {
            return (
              (t = r),
              (n = (e = e).type),
  ...
  function Un(e) {
    ...
    return (
      ...
      s({ weekYear: t, weekNumber: i, weekday: r }, it(e))
    );
  }
  function Pn(e) {
    var t,
      ...
      r = 7 * r + i - o - 3,
      i =
        (r < 1 ? (r += Ge((t = n - 1))) : a < r ? ((t = n + 1), (r -= Ge(n))) : (t = n), _n(t, r));
    return s({ year: t, month: i.month, day: i.day }, it(e));
  }
  function Rn(e) {
    var t = e.year;
    return s({ year: t, ordinal: qn(t, e.month, e.day) }, it(e));
  }
  function Hn(e) {
    var t = e.year,
      n = _n(t, e.ordinal);
    return s({ year: t, month: n.month, day: n.day }, it(e));
  }
  function Wn(e) {
    var t = Pe(e.year),
      n = S(e.month, 1, 12),
  ...
  function $n(e) {
    return null === e.weekData && (e.weekData = Un(e.c)), e.weekData;
  }
  function Bn(e, t) {
  ...
  function dr(e, t) {
    ...
    if (T(e.year)) u = r;
      ...
      for (var i = g(sr); !(o = i()).done; ) {
        var o = o.value;
        T(e[o]) && (e[o] = or[o]);
      }
      var a = Wn(e) || Yn(e);
      if (a) return L.invalid(a);
      var a = Xn(e, n.offset(r), n),
        u = a[0],
        a = a[1];
    }
  ...
  var L = (function () {
    ...
    (p.now = function () {
      ...
      (p.fromJSDate = function (e, t) {
        ...
        var n = k(t.zone, b.defaultZone);
        return n.isValid ? new p({ ts: e, zone: n, loc: w.fromObject(t) }) : p.invalid(Gn(n));
      }),
      ...
      (p.fromObject = function (e, t) {
        ...
        if (!n.isValid) return p.invalid(Gn(n));
        var r = b.now(),
      ...
      (p.fromISO = function (e, t) {
        void 0 === t && (t = {});
        var n = Tt(e, [Rt, Jt], [Ht, Gt], [Wt, $t], [Yt, Bt]);
      ...
      (p.fromFormat = function (e, t, n) {
        ...
        var r = n,
          ...
          i = [(r = Zn((r = i), e, t)).result, r.zone, r.specificOffset, r.invalidReason],
          r = i[0],
          o = i[1],
          a = i[2],
          i = i[3];
        return i ? p.invalid(i) : tr(r, o, n, "format " + t, e, a);
      }),
      ...
      (p.parseFormatForOpts = function (e, t) {
        e = Ln(e, w.fromObject((t = void 0 === t ? {} : t)));
        return e
          ? e
              .map(function (e) {
                return e ? e.val : null;
      ...
      (p.expandFormat = function (e, t) {
        return (
          void 0 === t && (t = {}),
          Fn(O.parseFormat(e), w.fromObject(t))
            .map(function (e) {
              return e.val;
            })
            .join("")
    ...
    return (
      ...
      (e.set = function (e) {
        ...
        n
          ...
          : (t = Hn(s({}, Rn(this.c), e)));
        i = Xn(t, this.o, this.zone);
        return Bn(this, { ts: i[0], o: i[1] });
      }),
      (e.plus = function (e) {
        return this.isValid ? Bn(this, er(this, E.fromDurationLike(e))) : this;
      }),
      (e.minus = function (e) {
        return this.isValid ? Bn(this, er(this, E.fromDurationLike(e).negate())) : this;
      }),
      ...
      (e.toFormat = function (e, t) {
        return (
          void 0 === t && (t = {}),
          this.isValid ? O.create(this.loc.redefaultToEN(t)).formatDateTimeFromString(this, e) : Jn
        );
      }),
      (e.toLocaleString = function (e, t) {
        return (
          void 0 === e && (e = G),
          void 0 === t && (t = {}),
          this.isValid ? O.create(this.loc.clone(t), e).formatDateTime(this) : Jn
        );
      }),
      ...
      (e.toRelative = function (e) {
        ...
        return (
          ...
          hr(t, this.plus(n), s({}, e, { numeric: "always", units: r, unit: i }))
        );
      }),
