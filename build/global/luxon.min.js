var luxon = (function (t) {
  ...
  var e = /(?:(Z)|([+-]\d\d)(?::?(\d\d))?)/,
    ...
    Oe = RegExp(a.source + ("(?:" + e.source + "?(?:\\[(" + r.source + ")\\])?)?")),
    M = RegExp("(?:T" + Oe.source + ")?"),
    Me = Se("weekYear", "weekNumber", "weekDay"),
    Ne = Se("year", "ordinal"),
  ...
  function Ue(t) {
    var e = t[1],
      n = t[2],
      r = t[3];
    return [Le(e, t[4], r, n, t[5], t[6], t[7]), d.utcInstance];
  }
  function Pe(t) {
    var e = t[1],
      n = t[2],
      ...
      o = t[5],
      a = t[6];
    return [Le(e, t[7], n, r, i, o, a), d.utcInstance];
  }
  var Re = p(/([+-]\d{6}|\d{4})(?:-?(\d\d)(?:-?(\d\d))?)?/, M),
    He = p(/(\d{4})-?W(\d\d)(?:-?(\d))?/, M),
    We = p(/(\d{4})-?(\d{3})/, M),
    Je = p(Oe),
    Ye = be(
      function (t, e) {
        return [{ year: De(t, e), month: De(t, e + 1, 1), day: De(t, e + 2, 1) }, null, e + 3];
      },
      Ee,
      Ve,
      Ie
  ...
  var E = (function () {
      ...
      return (
        ...
        (t.plus = function (t) {
          ...
          for (var e = y.fromDurationLike(t), n = {}, r = 0, i = N; r < i.length; r++) {
            var o = i[r];
        ...
        (t.set = function (t) {
          return this.isValid
            ? D(this, { values: s({}, this.values, re(t, y.normalizeUnit)) })
            : this;
        }),
        (t.reconfigure = function (t) {
          ...
          return D(this, { loc: e, matrix: t, conversionAccuracy: r });
        }),
        (t.as = function (t) {
          ...
          return this.isValid
            ? ((t = this.toObject()),
              ...
              rn.reduce(function (t, e) {
                return b(r[e]) ? t : (t && on(n, r, t, r, e), e);
              }, null),
              D(this, { values: t }, !0))
            : this;
        }),
          ...
          for (
            ...
            if (0 <= e.indexOf(c)) {
              ...
              for (h in ((o[c] = (1e3 * d - 1e3 * (i[c] = m)) / 1e3), a))
                N.indexOf(h) > N.indexOf(c) && on(this.matrix, a, h, i, c);
            } else v(a[c]) && (o[c] = a[c]);
          }
        ...
        (t.equals = function (t) {
          ...
          for (var e, n = 0, r = N; n < r.length; n++) {
            var i = r[n];
            if (
              ((e = this.values[i]),
              (i = t.values[i]),
      ...
      return (
        ...
        (t.toLocaleString = function (t, e) {
          return (
            void 0 === t && (t = $),
            void 0 === e && (e = {}),
            this.isValid ? S.create(this.s.loc.clone(e), t).formatInterval(this) : an
          );
        }),
        (t.toISO = function (t) {
        ...
        (t.toFormat = function (t, e) {
          ...
          return this.isValid ? "" + this.s.toFormat(t) + e + this.e.toFormat(t) : an;
        }),
        (t.toDuration = function (t, e) {
          return this.isValid ? this.e.diff(this.s, t, e) : E.invalid(this.invalidReason);
        }),
  ...
  function cn(t, e) {
    ...
    e = n(e) - n(t);
    return Math.floor(E.fromMillis(e).as("days"));
  }
  function ln(t, e, n, r) {
    var t = (function (t, e, n) {
      ...
      e =
        (0 === n.length &&
          ...
          (o[t] = (o[t] || 0) + u / (a - i)),
        E.fromObject(o, r));
    return 0 < n.length ? (t = E.fromMillis(u, r)).shiftTo.apply(t, n).plus(e) : e;
  }
  var fn = {
      arab: "[٠-٩]",
      arabext: "[۰-۹]",
  ...
  function V(t) {
    return void 0 === t && (t = ""), new RegExp("" + fn.latn + t);
  }
            ...
            (function (t) {
              ...
              if (isNaN(e)) {
                for (var e = "", n = 0; n < t.length; n++) {
                  ...
                  if (-1 !== t[n].search(fn.hanidec)) e += hn.indexOf(t[n]);
                  else
                    for (var i in dn) {
                      var i = dn[i],
                        o = i[0],
  ...
  var yn = V(),
    ...
    Mn = new RegExp(On, "g");
  function Nn(t) {
    return t.replace(/\./g, "\\.?").replace(Mn, On);
  }
  function Dn(t) {
    ...
    return (e = Array.prototype).concat.apply(
      ...
      t.map(function (t) {
        return (
          (e = n),
          (t = t).literal ||
          null == (e = Ln(S.macroTokenToFormatOpts(t.val), e)) ||
          e.includes(void 0)
            ? t
            : e
        );
  ...
  function Pn(t) {
    var e,
      ...
      r = 7 * r + i - o - 3,
      i =
        (r < 1 ? (r += $t((e = n - 1))) : a < r ? ((e = n + 1), (r -= $t(n))) : (e = n), _n(e, r));
    return s({ year: e, month: i.month, day: i.day }, oe(t));
  }
  function Rn(t) {
    var e = t.year;
    return s({ year: e, ordinal: qn(e, t.month, t.day) }, oe(t));
  }
  function Hn(t) {
    var e = t.year,
      n = _n(e, t.ordinal);
    ...
    (p.now = function () {
      ...
      (p.utc = function () {
        ...
        return (
          ...
          dr({ year: n, month: r, day: i, hour: o, minute: a, second: u, millisecond: t }, e)
        );
      }),
      ...
      (p.fromISO = function (t, e) {
        void 0 === e && (e = {});
        var n = Te(t, [Re, Ye], [He, Ge], [We, $e], [Je, Be]);
      ...
      (p.fromHTTP = function (t, e) {
        void 0 === e && (e = {});
        t = Te(t, [ze, Ue], [qe, Ue], [_e, Pe]);
        return er(t[0], t[1], e, "HTTP", e);
      }),
      (p.fromFormat = function (t, e, n) {
        ...
        var r = n,
          ...
          i = [(r = Fn((r = i), t, e)).result, r.zone, r.specificOffset, r.invalidReason],
          r = i[0],
          o = i[1],
          a = i[2],
          i = i[3];
        return i ? p.invalid(i) : er(r, o, n, "format " + e, t, a);
      }),
      ...
      (p.parseFormatForOpts = function (t, e) {
        t = Ln(t, g.fromObject((e = void 0 === e ? {} : e)));
        return t
          ? t
              .map(function (t) {
                return t ? t.val : null;
      ...
      (p.expandFormat = function (t, e) {
        return (
          void 0 === e && (e = {}),
          Zn(S.parseFormat(t), g.fromObject(e))
            .map(function (t) {
              return t.val;
            })
            .join("")
    ...
    return (
      ...
      (t.setZone = function (t, e) {
        ...
        return (t = w(t, k.defaultZone)).equals(this.zone)
          ...
          : t.isValid
          ? ((n = this.ts),
            (r || e) && ((r = t.offset(this.ts)), (n = Xn(this.toObject(), r, t)[0])),
            Bn(this, { ts: n, zone: t }))
          : p.invalid(Gn(t));
      }),
      (t.reconfigure = function (t) {
      ...
      (t.set = function (t) {
        ...
        n
          ...
          : (e = Hn(s({}, Rn(this.c), t)));
        i = Xn(e, this.o, this.zone);
        return Bn(this, { ts: i[0], o: i[1] });
      }),
      (t.plus = function (t) {
        return this.isValid ? Bn(this, tr(this, E.fromDurationLike(t))) : this;
      }),
      (t.minus = function (t) {
        return this.isValid ? Bn(this, tr(this, E.fromDurationLike(t).negate())) : this;
      }),
      ...
      (t.toFormat = function (t, e) {
        return (
          void 0 === e && (e = {}),
          this.isValid ? S.create(this.loc.redefaultToEN(e)).formatDateTimeFromString(this, t) : Yn
        );
      }),
      (t.toLocaleString = function (t, e) {
        return (
          void 0 === t && (t = $),
          void 0 === e && (e = {}),
          this.isValid ? S.create(this.loc.clone(e), t).formatDateTime(this) : Yn
        );
      }),
      ...
      (t.toISO = function (t) {
        var e,
          ...
          t = void 0 !== t && t;
        return this.isValid
          ? ((e = rr(this, (n = "extended" === (void 0 === n ? "extended" : n)))),
            (e += "T") + ir(this, n, r, i, o, t))
          : null;
      }),
      (t.toISODate = function (t) {
        t = (void 0 === t ? {} : t).format;
        return this.isValid ? rr(this, "extended" === (void 0 === t ? "extended" : t)) : null;
      }),
        ...
        return (
          ...
          this.isValid && t.isValid
            ? ((n = s({ locale: this.locale, numberingSystem: this.numberingSystem }, n)),
              (e = e),
              (e = (Array.isArray(e) ? e : [e]).map(E.normalizeUnit)),
              (t = ln((r = t.valueOf() > this.valueOf()) ? this : t, r ? t : this, e, n)),
              r ? t.negate() : t)
      ...
      (t.toRelative = function (t) {
        ...
        return this.isValid
          ? ((e = (t = void 0 === t ? {} : t).base || p.fromObject({}, { zone: this.zone })),
            ...
            hr(e, this.plus(n), s({}, t, { numeric: "always", units: r, unit: i })))
          : null;
      }),
